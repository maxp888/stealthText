...
public class stPC extends PApplet {
...
static protected int colorScheme[] = {
	0xff000000, //black
	0xffD3D3E1, //background
	0xffB5B5CD, //key grey
	0xffFFFF5C, //row/col highlite
	0xffFFCC00, //cell selection
	0xff00FF00, //last used
};
...
public void parseString(String s){
	if (s.equals("DEL")){
		...
		if (s.substring(0,2).equals("#R")) {
			grid.setRow(PApplet.parseInt(s.substring(2)));
		} else if (s.substring(0,2).equals("#C")) {
			grid.setCol(PApplet.parseInt(s.substring(2)));
		}
	} else {
		if (bldString == null){
			bldString = s;
...
protected class Grid{
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "stPC" };
    if (passedArgs != null) {
